...
const NumericAnswerSectionInput = React.createClass({
  propTypes: {
  ...
  render() {
    return (
      <div>
        ...
        <SimpleInput name={ this.getNameFor(['answer']) } id="answer"
          value={ _.get(this, 'props.section.answer', '') }
          type="number" title="Answer" required
        />
      </div>
    );
  },
...
export default NumericAnswerSectionInput;
